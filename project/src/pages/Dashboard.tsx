...
import { Calendar, Users, Clock, IndianRupee, TrendingUp, CheckSquare, RefreshCw } from 'lucide-react';
          ...
          {[
            {
              ...
              value: summaryStats.total_meetings,
            ...
            },
            {
              icon: Clock,
              label: 'Total Hours',
              value: summaryStats.total_hours,
            ...
            },
            {
              ...
              value: summaryStats.unique_participants,
